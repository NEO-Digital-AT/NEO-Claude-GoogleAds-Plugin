...
| `google-ads-selftest.py` | Weist ohne Netz nach, dass Schutzgrenzen, Portal und Zwei-Faktor, Passkeys und QR-Code greifen — 275 Fälle |
...
| `portal_shell.py` | Der Rahmen der Konsole: Seitenleiste, Kopfzeile, schmale Anmeldeseiten, Bausteine |
